          ...
          <div className="hidden md:flex items-center space-x-4">
            {!isLoggedIn ? (
              <>
                ...
                <Link
                  href="/register"
                  className="text-sm font-semibold bg-[var(--primary)] hover:bg-[var(--primary-hover)] text-white px-5 py-2.5 rounded-xl transition-all shadow-[0_4px_14px_0_var(--primary-shadow)] hover:-translate-y-0.5"
                >
                  Get Started Free
                </Link>
              </>
              ...
              <>
                ...
                <button
                  type="button"
                  className="p-2 text-[var(--text-muted)] hover:text-[var(--text-secondary)] transition-colors relative"
                ...
                <button
                  ...
                  className="rounded-lg border border-[var(--border)] bg-[var(--surface)] px-3 py-2 text-sm font-medium text-[var(--text-secondary)] transition-colors hover:border-[var(--primary)] hover:text-[var(--primary)]"
                >
                  AI Context
                </button>
          ...
          <div className="flex flex-col space-y-4">
            {!isLoggedIn ? (
              <>
                ...
                <Link
                  href="/register"
                  className="text-base text-center font-semibold bg-[var(--primary)] text-white px-5 py-3 rounded-xl"
                >
                  Get Started Free
                </Link>
              </>
              ...
              <>
                ...
                <button
                  ...
                  className="text-left text-base font-semibold text-[var(--primary)]"
                >
                  AI Context
                </button>
                ...
                <button
                  type="button"
                  className="text-left text-base font-semibold text-[var(--danger)]"
                >
                  Sign Out
                </button>
              </>
